...
public class ForExample {
	...
	/*
	 * for 문 - 끝이 정해져 있는(횟수가 지정되어 있는) 반복문
	 * 
	 * [작성법]
	 * 
	 * for(초기식; 조건식; 증감식) {
	 * 
	 * 반복 수행할 코드 } - 초기식 : for문을 제어하는 용도의 변수 선언
	 * 
	 * - 조건식 : for문의 반복 여부를 지정하는 식 (다음 반복 진행해?) 보통 초기식에 사용된 변수를 이용하여 조건식을 작성함
	 * 
	 * - 증감식 : 초기식의 사용된 변수를 for문이 끝날 때 마다 증가 또는 감소 시켜 조건식의 결과를 변하게 하는 식
	 * 
	 * 
	 */
	...
	public void ex7() {
		...
		for (int i = 'A'; i <= 'Z'; i++) {
			System.out.print((char) i + " "); // 강제 형변환을 했다
		}
	...
	public void ex15() {
		...
		// 단, 2 ~ 19 사이 단이 입력되지 않으면 "잘못 입력 하셨습니다."
	...
	public void ex16() {
		...
		for (int dan = 2; dan <= 9; dan++) { // 2 ~ 9단까지 차례대로 증가
			...
			System.out.println(" "); // 아무 내용 없는 println()
		}
	}
	...
	public void ex17() {
		...
		for (int dan = 9; dan >= 2; dan--) { // 단 9 > 2 역순
