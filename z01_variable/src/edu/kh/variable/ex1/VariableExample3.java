...
public class VariableExample3 {
	...
	public static void main(String[] args) {
		...
		// long -> float 자동 형변환
		long l5 = 132345678912456789L;
		float f5 = l5 * 100;
		// float = long * int;
		// float = long * long;
		// float = long 결과
		// float = float(자동 형변환)
		System.out.println(f5); // -5.212176E18 (오버플로우)
		
		// 오버플로우 현상은 컴퓨터가 미리 예측을 할 수 없다.
		// -> 개발자가 미리 예측해야함
		
		// (byte b1 = 128; 하면 에러나지만 대입해서 계산하면 인식 못함)
		int i6 = 2147483647; // int 최대값
		int result6 = i6 + 1;
		System.out.println(result6); // -2147483648
		// double 혹은 long으로 바꿔주면 됨(값의 범위가 더 크기 때문)
