...
public class BranchExample {
	...
	public void ex3() {
		...
		String str = ""; // 빈문자열
					     // 쌍따옴표("") 라는 기호를 이용해서 String 리터럴임을 지정
		 				 // 하지만 내용이 없음
		...
		while( true ) { // 무한루프
			...
			if( input.equals("exit!") ) {
				...
				// *** 해결 방법 : 문자열1.equals(문자열2) 으로 비교 가능하다. ***
				break;
			}
...
//		}
	...
	public void ex7() {
		...
		for(int i = 1; i <= round; i++) { // 입력 받은 판 수 만큼 반복
			...
			// 컴퓨터 가위/바위/바위/보 정하기(랜덤)
			// 1) 1~3 사이 난수  생성
			// 2) 1이면 가위, 2이면 바위, 3이면 보 지정
			
			// 난수 생성 방법 : Math.randon()
			...
			// null : 아무것도 참조하고 있지 않음, 주소(참조형이여서)x
			...
			// The local variable com may not have been initialized -> defualt 구문 왜 안넣어줘! (default 대신 null)
