...
public class WhileExample {
	...
	/*
	 * while문 - 별도의 초기식, 증감식이 존재하지 않고 반복 종료 조건을 자우롭게 설정하는 반복문
	 *
	 * ** 확실히 언제 반복이 끝날지는 모르지만 언젠가 반복 조건이 false가 되는 경우 반복을 종료함.
	 * 
	 * [작성법] while( 조건식 ){ 조건식이 true일 때 반복 수행할 구문 }
	 * 
	 */
