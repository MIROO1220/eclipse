...
public class CastingPratice {
	...
	public static void main(String[] args) {
		...
		System.out.println(iNum1 - (iNum2+iNum2)); // iNum1 iNum2를 이용해서 2 만들기
		...
		System.out.println(iNum1 / (int)fNum); //3을 만들 수 있는 방법
		
		//float / double 차이점 
						// 10	/	3.0f
		System.out.println( iNum1 / fNum); // 3.333333333
						// 10	/	3.0
		...
		System.out.println((char)(ch + iNum1)); // 'K'를 출력하는 문구
